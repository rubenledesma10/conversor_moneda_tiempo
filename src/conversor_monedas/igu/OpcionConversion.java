...
public class OpcionConversion extends javax.swing.JFrame {
    ...
    private void btnContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContinuarActionPerformed
        ...
        if (tipoCambio.equalsIgnoreCase("Pesos a Dólar")) {
            ...
            double total = monto / dolar;

            mostrarMensaje("Usted tiene " + total + " dolares", "Info", "Conversión realizada exitosamente");
            txtMonto.setText("");
            ...
            double euro = 399.33;
            double monto = Double.parseDouble(txtMonto.getText());
            double total = monto / euro;

            mostrarMensaje("Usted tiene " + total + " euros", "Info", "Conversión realizada exitosamente");
            txtMonto.setText("");
            VentanaConfirmacion ventana = new VentanaConfirmacion();
            ventana.setVisible(true);
            ventana.setLocationRelativeTo(null);
            ...
            double monto = Double.parseDouble(txtMonto.getText());
            double total = monto / libras;

            mostrarMensaje("Usted tiene " + total + " libras", "Info", "Conversión realizada exitosamente");
            txtMonto.setText("");
            VentanaConfirmacion ventana = new VentanaConfirmacion();
            ventana.setVisible(true);
            ventana.setLocationRelativeTo(null);
            ...
            double yen = 145.89;
            double monto = Double.parseDouble(txtMonto.getText());
            double total = monto / yen;

            mostrarMensaje("Usted tiene " + total + " yen", "Info", "Conversión realizada exitosamente");
            txtMonto.setText("");
            VentanaConfirmacion ventana = new VentanaConfirmacion();
            ventana.setVisible(true);
            ventana.setLocationRelativeTo(null);
            ...
            double won = 3.83;
            double monto = Double.parseDouble(txtMonto.getText());
            double total = monto / won;

            mostrarMensaje("Usted tiene " + total + " won coreanos", "Info", "Conversión realizada exitosamente");
            txtMonto.setText("");
            VentanaConfirmacion ventana = new VentanaConfirmacion();
            ventana.setVisible(true);
            ventana.setLocationRelativeTo(null);
            ...
            if (monto == 0) {
                ...
                mostrarMensaje("Usted tiene " + total + " pesos", "Info", "Conversión realizada exitosamente");
                txtMonto.setText("");
                VentanaConfirmacion ventana = new VentanaConfirmacion();
                ventana.setVisible(true);
                ventana.setLocationRelativeTo(null);
