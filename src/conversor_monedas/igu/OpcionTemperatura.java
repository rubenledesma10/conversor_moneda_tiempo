...
public class OpcionTemperatura extends javax.swing.JFrame {
    ...
    private void btnContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContinuarActionPerformed
        ...
        if (tipoTemperatura.equalsIgnoreCase("Celsius a Fahrenheit")) {
            ...
            mostrarMensaje("La temperatura en Celsius que usted ingreso convertida en Fahrenheit es " + resultado,
            ...
            DecimalFormat df = new DecimalFormat("0.00");
            String resultado = df.format(kelvin);

            mostrarMensaje("La temperatura en Celsius que usted ingreso convertida en Kelvin es " + resultado,
                    "Info", "Exito al realizar la conversión");
            ...
            mostrarMensaje("La temperatura en Fahrenheit que usted ingreso convertida en Celsius es " + resultado,
                    "Info", "Exito al realizar la conversión");
            txtTemperatura.setText("");
            ...
            mostrarMensaje("La temperatura en Fahrenheit que usted ingreso convertida en kelvin es " + resultado,
                    "Info", "Exito al realizar la conversión");
            txtTemperatura.setText("");
            ...
            mostrarMensaje("La temperatura en Kevin que usted ingreso convertida en celsius es " + resultado,
                    "Info", "Exito al realizar la conversión");
            txtTemperatura.setText("");
